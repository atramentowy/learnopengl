...
int main() {
    ...
    std::filesystem::path cubeTexturePath = projectRoot/"res"/"wall.jpg";
    ...
    std::filesystem::path transparentTexturePath = projectRoot/"res"/"grass.png";
    unsigned int transparentTexture = loadTexture(transparentTexturePath.string().c_str());
    std::filesystem::path glassTexturePath = projectRoot/"res"/"window.png";
    unsigned int glassTexture = loadTexture(glassTexturePath.string().c_str());
